...
def main():
    ...
    img_dir, lbl_dir = root_dir / "images/train", root_dir / "labels/train"
    
    # Target directories for moved files
    refine_img_dir = root_dir / "needs_refinement" / "images"
    refine_lbl_dir = root_dir / "needs_refinement" / "labels"
